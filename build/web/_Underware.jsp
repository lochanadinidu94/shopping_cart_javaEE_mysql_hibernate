    ...
    <body onload="lordTable(0, 'a', 'a', 'a');" style="background: url(img/Backimage1.jpg) repeat top left;">
        ...
        <div Class="maintable_w" style="margin-left: 10px;" id="ma1">
            ...
            <div class="imageitem_w" id="wap">
                ...
                <center>
                    Sub Category:
                    <select class="form-control" style="width:150px;display: inline;" id="scata5" onchange="brandAdvanSearch()">
                        ...
                        <%                            Session sks = new HibernateConnection().getSessionFactory().openSession();
                            ...
                            cr.add(Restrictions.eq("name", "Underwear"));
...
//                    alert(m);
            ...
            obj.send('cata=Underwear&scata=' + document.getElementById('scata5').value);
...
//                    alert(m);
            ...
            obj.setRequestHeader('Content-Type', 'application/x-www-form-urlencoded');
            obj.send('cata=Underwear&scata=' + document.getElementById('scata5').value + '&model=' + document.getElementById('br1').value);
        ...
        function lordTable(a, sub, brn, mod) {
            ...
            obj.open("POST", "UnderItemLord", true);
            obj.setRequestHeader('Content-Type', 'application/x-www-form-urlencoded');
