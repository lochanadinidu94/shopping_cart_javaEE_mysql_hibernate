    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function lordTable(a) {
                ...
                obj.open("POST", "TrouserItemLord", true);
                obj.setRequestHeader('Content-Type', 'application/x-www-form-urlencoded');
                obj.send('currentpage=' + a);
            }
            function bl(a, b) {
//                alert(a);
//                alert(b);
                ...
                <center>
                    ...
                    <select class="form-control" style="width:150px;display: inline;">
                        ...
                        <%
                            ...
                            Criteria ck = sks.createCriteria(Databasefile.Catagory1.class);
                            ck.add(Restrictions.eq("name", "Trouser"));
                            Databasefile.Catagory1 cw = (Catagory1) ck.uniqueResult();
                    ...
                    Brand:<select class="form-control" style="width:150px;display: inline; float: left;"></select>
                    Model:<select class="form-control" style="width:150px;display: inline; float: left;"></select>
                    <button class="btn btn-default" style="display: inline; float: left;">Search</button>
                </center>
