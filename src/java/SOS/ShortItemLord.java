 ...
 * @author Lochana
 */
public class ShortItemLord extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                ...
                cc.add(Restrictions.eq("name", "Short"));
...
//                    }
                ...
                for (int i = 0; i <= pag; ++i) {
                    ...
                    b += "<a onclick='lordTable(" + Integer.valueOf(i) + ");' class='label label-warning'> Page : " + Integer.valueOf(i+1) + "</a>";
