 ...
 * @author Lochana
 */
public class lorduserinfo extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            try {
                ...
                job.put("Gen", ur.getGender().getName());

                Criteria cr1 = ses.createCriteria(Databasefile.Login.class);
                cr1.add(Restrictions.eq("user", ur));
                Databasefile.Login lo = (Databasefile.Login) cr1.uniqueResult();

                job.put("Pas", lo.getPassword());
