 ...
 * @author Lochana
 */
public class lordcatagory extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                ...
                Criteria cr = ses.createCriteria(Databasefile.Catagory1.class);
                List<Databasefile.Catagory1> li = cr.list();

                JSONArray jsa = new JSONArray();
                JSONObject jso = new JSONObject();

                for (Catagory1 li1 : li) {
                    HashMap hm = new HashMap();
                    hm.put("data", li1.getName());
                    jsa.put(hm);
                }
                jso.put("Cata", jsa);
