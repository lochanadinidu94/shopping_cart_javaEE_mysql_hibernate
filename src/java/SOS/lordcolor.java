 ...
 * @author Lochana
 */
public class lordcolor extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                ...
                Criteria cr = ses.createCriteria(Databasefile.Color.class);
                List<Databasefile.Color> li = cr.list();
