    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                ...
                if (lo.getUser().getUserType().endsWith("User")) {
                    ses.close();
                    out.write("You Can't use this");
                } else {
                    ...
                    String html = "<table width=\"750px\" height=\"500\">\n"
                            ...
                            + "        <td><center><a href=\"http://localhost:8080/Final_AJD_Project/_Admin_Login.jsp\">Click & Login</a></center></td> \n"
                            + "    </tr>\n"
                            + "</table>";
