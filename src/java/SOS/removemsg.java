    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                ...
                Criteria c = ses.createCriteria(Databasefile.Msg.class);
                c.add(Restrictions.eq("idMsg", Integer.valueOf(mid)));
                Databasefile.Msg msg =  (Databasefile.Msg) c.uniqueResult();
                
                ses.delete(msg);
                tr.commit();
                
                ses.close();
                out.write("Successfull Remove");
