 ...
 * @author Lochana
 */
public class cahagestatus extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                ...
                Criteria cr2 = ses.createCriteria(Databasefile.Productstates.class);
                cr2.add(Restrictions.eq("name", ns));
                Databasefile.Productstates ps = (Databasefile.Productstates) cr2.uniqueResult();

                pro.setAmount(Double.valueOf(na));
                pro.setProductstates(ps);
