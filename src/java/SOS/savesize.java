 ...
 * @author Lochana
 */
public class savesize extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                ...
                Databasefile.Sizetype s =  (Databasefile.Sizetype) c1.uniqueResult();
                
                Databasefile.Size sss = new Databasefile.Size();
                sss.setSizetype(s);
                sss.setName(value);
                ses.save(sss);
                tr.commit();
                ...
                ses.close();
                out.write("Successful Size Registation");
