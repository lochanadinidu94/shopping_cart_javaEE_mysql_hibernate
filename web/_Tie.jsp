                ...
                <center>
                    ...
                    <select class="form-control" style="width:150px;display: inline;" id="scata5" onchange="brandAdvanSearch()">
                        ...
                        <%                            Session sks = new HibernateConnection().getSessionFactory().openSession();
                            ...
                            cr.add(Restrictions.eq("name", "Tie"));
...
//                    alert(m);
            ...
            obj.send('cata=Tie&scata=' + document.getElementById('scata5').value);
...
//                    alert(m);
            ...
            obj.setRequestHeader('Content-Type', 'application/x-www-form-urlencoded');
            obj.send('cata=Tie&scata=' + document.getElementById('scata5').value + '&model=' + document.getElementById('br1').value);
        ...
        function lordTable(a, sub, brn, mod) {
            ...
            obj.open("POST", "TietemLord11", true);
            obj.setRequestHeader('Content-Type', 'application/x-www-form-urlencoded');
