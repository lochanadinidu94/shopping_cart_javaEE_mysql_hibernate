                ...
                <center>
                    ...
                    <select class="form-control" style="width:150px;display: inline;" id="scata5" onchange="brandAdvanSearch()">
                        ...
                        <%                            Session sks = new HibernateConnection().getSessionFactory().openSession();
                            ...
                            cr.add(Restrictions.eq("name", "TShirt"));
...
//                    alert(m);
            ...
            obj.send('cata=TShirt&scata=' + document.getElementById('scata5').value);
...
//                    alert(m);
            ...
            obj.setRequestHeader('Content-Type', 'application/x-www-form-urlencoded');
            obj.send('cata=TShirt&scata=' + document.getElementById('scata5').value + '&model=' + document.getElementById('br1').value);
...
//                alert(sub)
            ...
            obj.open("POST", "TShirtItemLord", true);
            obj.setRequestHeader('Content-Type', 'application/x-www-form-urlencoded');
